-- Complète 20260908090000 (et 093000/094500/100000/103000/110000/130000/
-- 150000) : ajoute `photos` et `journal_entries` au jsonb retourné par
-- public.get_shared_character -- nécessaire pour que la vue en lecture
-- seule affiche la galerie de photos et le journal de campagne de l'onglet
-- "Histoire" au même titre que les 9 champs *_text déjà exposés (chantier
-- "Galerie de photos, journal de campagne",
-- docs/cahier-des-charges/11-fonctionnalites-a-ajouter.md, section "Onglet
-- Histoire"). Tables créées par 20260909160000_create_character_photos.sql
-- et 20260909170000_create_character_journal_entries.sql.
--
-- Copie exacte du corps de la fonction tel que laissé par 20260909150000
-- (relu depuis ce fichier avant d'écrire cette migration) : seuls les blocs
-- `'photos', coalesce(...)` et `'journal_entries', coalesce(...)` sont
-- nouveaux.
